                    ...
                    <section className='flex items-center justify-between  h-screen'>
                        ...
                        <div className='w-3/6 h-full flex justify-end'>
                            <div className='w-11/12 h-11/12 relative flex justify-center items-center'>
                                <Image src="/img/Back_Image.png" alt="My Fond" className='absolute w-11/12 h-11/12' width={900} height={900}/>
                                <Image src="/img/Me.png" alt="My picture" className='absolute w-6/12' width={900} height={900}/>
                            </div>
                        </div>
                    </section>
