        ...
        <main>
          <section className="flex items-center justify-between h-screen">
            <div className="flex flex-col justify-center w-3/6 h-3/6">
              <span className="text-xl text-Categories">
                -&nbsp; M Y &nbsp; N A M E &nbsp; I S
              </span>
              <h1 className="text-5xl font-bold pt-4">
                Emilie <span className="text-MyColor">Montpre.</span>
              </h1>
              <p className="py-9">
                Hello, my name is Emilie, I am 20 years old and I am student in
                web and mobile development. I am motivated dedicated to learn
                and ready to put my knowledge and my skills at the service of
                your business
              </p>
              <Reseaux />
            </div>
            <div className="w-3/6 h-full flex justify-end">
              <div className="w-11/12 h-11/12 relative flex justify-center items-center">
                <Image
                  src="/img/Back_Image.png"
                  alt="My Fond"
                  className="absolute w-11/12 h-11/12"
                  width={900}
                  height={900}
                />
                <Image
